...
description: Tear down Purview lab resources safely using Remove-Lab.ps1, including manifest-based precise removal and prefix-based fallback cleanup.
---
