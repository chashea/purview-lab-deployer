...
4. Update cloud capability metadata:
   ...
   - AI scenario profiles: `profiles/<cloud>/ai/capabilities.json`
   - Sentinel scenario profiles: `profiles/<cloud>/purview-sentinel/capabilities.json`
...
5. If workload config shape changes, update cloud-scoped config files under:
   ...
   - `configs/gcc/*.json`
   - Integrated AI config: `configs/<cloud>/ai-demo.json`
