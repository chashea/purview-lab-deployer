# Shadow AI Prevention Demo — Customer Talk Track (GCC)

## Overview

**Duration:** 15-20 minutes
**Audience:** GCC/Government CISO, Security/Compliance leadership, IT decision-makers
...
>
> What I've deployed here is a fully automated Purview lab configured for GCC that demonstrates a tiered governance model for AI data protection. Let me walk you through it."
...
> "Microsoft 365 G5 (GCC) or G5 Compliance for the full stack. G3 + G5 Compliance add-on also works. Copilot requires a separate Copilot for Microsoft 365 license."
...
**Q: "Are there any GCC-specific limitations?"**
> "GCC environments may have slightly delayed feature rollouts compared to commercial. Communication Compliance and Insider Risk Management have limited feature parity — some advanced templates or DSPM workflows may not yet be available. Conditional Access integration for AI apps should be managed separately through the Entra admin center. The core DLP, sensitivity labels, and eDiscovery capabilities are fully available."

---

## GCC Considerations

- Conditional Access policies are not included in the automated deployment — configure manually via Entra admin center if needed
- Communication Compliance feature parity may differ; verify available templates before demo
- Insider Risk Management templates may vary by GCC rollout stage
- All DLP, sensitivity label, retention, and eDiscovery features are fully supported
