# Shadow AI Demo — Manual Configuration Runbook (GCC)
...
- Microsoft 365 G5 (GCC) or G5 Compliance add-on
...
> **Note:** Some features may have limited availability in GCC environments. Steps that require unavailable features should be skipped.
...
> **Note:** Cloud Discovery integration with Defender for Endpoint may have delayed rollout in GCC.
...
> **Note:** App Governance features may vary in GCC. Verify availability in your tenant.
...
## 6. Pre-populate Alerts (optional, for demo impact)
...
- [ ] GCC-specific feature limitations documented and communicated to demo team
